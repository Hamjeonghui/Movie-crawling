...
//					System.out.println("Mv_DAO로그 : 재고부족");
					conn.rollback();
				} else {
...
//		System.out.println("Mv_DAO로그 : 재고 수정 성공");
	...
	// [상세정보 조회]
/*	public ArrayList<Mv_VO> selectOne (Mv_VO vo){
	...
	public ArrayList<Mv_VO> selectAll (Mv_VO vo) { // [목록조회]
		ArrayList<Mv_VO> datas = new ArrayList<Mv_VO>();
		conn=JDBCUtill.connect();
...
//		System.out.println("Mv_DAO 로그 : 목록조회 성공");
	...
	// [가격수정]
	public boolean upatePrice (Mv_VO vo) {
		conn = JDBCUtill.connect();
		try {
